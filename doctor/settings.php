...
<body>
        ...
        <tr>
          ...
          <td width="15%">
            ...
            <p class="heading-sub12" style="padding: 0;margin: 0;">
              ...
              // PERBAIKAN: Mengganti query() MySQLi dengan PDO query() untuk statistik
  ...
  if ($_GET) {
    ...
    if ($action == 'drop') {
      ...
      $spcil_res_stmt = $database->prepare("select sname from specialties where id=?");
      ...
      // PERBAIKAN: Konversi kueri edit detail dari MySQLi ke PDO
      $sqlmain = "select * from doctor where docid=?";
      $stmt = $database->prepare($sqlmain);
      $stmt->execute([$id]);
      $row = $stmt->fetch(PDO::FETCH_ASSOC);
      ...
      if ($error_1 != '4') {
        ...
        // PERBAIKAN: Konversi kueri specialties list dari MySQLi ke PDO query() dan loop PDO fetch()
