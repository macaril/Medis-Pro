...
// PERBAIKAN: Kueri statistik menggunakan JOIN yang sudah di-CAST (schedule.docid::integer)
                    ...
                    <div class="abc scroll" style="height: 250px;padding: 0;margin: 0;">
                      <table width="85%" class="sub-table scrolldown" border="0">
                        ...
                        <tbody>
                          ...
                          // PERBAIKAN: Menambahkan casting ::integer untuk join schedule.docid=doctor.docid
                          $sqlmain = "select schedule.scheduleid,schedule.title,doctor.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join doctor on schedule.docid::integer=doctor.docid  where schedule.scheduledate>='$today' and schedule.scheduledate<='$nextweek' order by schedule.scheduledate desc";
