...
if($_POST){
    ...
    // Variabel $result di baris ini tidak digunakan dan dihapus
    ...
    if ($newpassword==$cpassword){
        ...
        // PDO Syntax: bind dan execute dilakukan dalam satu langkah
        $stmt->execute([$email]); 
        
        // PDO: Mengambil satu baris. Jika ada, variabel akan berisi array.
        $user_exists = $stmt->fetch(PDO::FETCH_ASSOC);

        // PDO: Memeriksa apakah user sudah ada
        if($user_exists){ 
...
<body>
    ...
    <div class="container">
        <table border="0" style="width: 69%;">
            ...
            <tr>
                <td class="label-td" colspan="2">
                    <input type="tel" name="tele" class="input-text"  placeholder="ex: 0712345678" pattern="[0]{1}[0-9]{11,13}" >
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
