    ...
    <div class="container">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4">
                        <div style="display: flex;margin-top: 40px;">
                            ...
                            <a href="?action=add-session&id=none&error=0" class="non-style-link"><button class="login-btn btn-primary btn button-icon" style="margin-left:25px;background-image: url('../img/icons/add.svg');">Add a Session</button>
                            </a>
                        </div>
                    </td>
                </tr>
                ...
                <?php
                // Logika Prepared Statement Dinamis
                ...
                if ($_POST) {
                    if (!empty($_POST["sheduledate"])) {
                        // PERBAIKAN: Menggunakan parameter binding untuk tanggal
                        $where_clauses[] = " schedule.scheduledate = ? ";
                        $params[] = $_POST["sheduledate"];
                    }

                    if (!empty($_POST["docid"])) {
                        // PERBAIKAN: Menggunakan parameter binding untuk docid
                        $where_clauses[] = " doctor.docid = ? ";
                        $params[] = (int)$_POST["docid"];
                    }
                }

                if (count($where_clauses) > 0) {
                    $sqlmain = $sqlmain_base . " WHERE " . implode(" AND ", $where_clauses);
                } else {
