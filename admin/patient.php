...
<body>
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">All Patients (<?php echo $list11->rowCount(); // Menggunakan rowCount() dari query datalist ?>)</p>
                    </td>
                ...
                if ($_POST) {
                    ...
                    // PERBAIKAN KRITIS: Menggunakan Prepared Statement untuk pencarian yang aman
                    // Menggunakan ILIKE untuk case-insensitive search di PostgreSQL
                    $sqlmain = "SELECT * FROM patient WHERE pemail ILIKE ? OR pname ILIKE ? OR pname ILIKE ? OR pname ILIKE ? OR pname ILIKE ? ORDER BY pid DESC";
    ...
    if ($_GET) {
        ...
        // PERBAIKAN: Konversi kueri view detail dari MySQLi ke PDO Prepared Statement
