...
$userfetch = $stmt->fetch(PDO::FETCH_ASSOC); // PDO fetch
...
// PERBAIKAN: Konversi kueri statistik dari MySQLi ke PDO query() (rowCount akan digunakan di HTML)
                                ...
                                <td>
                                    ...
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            // PERBAIKAN KRITIS: Menambahkan type casting (::text) pada docid di JOIN
                                            $sqlmain = "SELECT appointment.appoid,schedule.scheduleid,schedule.title,doctor.docname,patient.pname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate 
                                                        ...
                                                        WHERE patient.pid=? AND schedule.scheduledate>=? ORDER BY schedule.scheduledate asc";
                                            
                                            // PERBAIKAN: Mengganti query() MySQLi dengan PDO Prepared Statement
                                            $stmt_upcoming = $database->prepare($sqlmain);
                                            $stmt_upcoming->execute([$userid, $today]);
                                            ...
                                            while ($row = $stmt_upcoming->fetch(PDO::FETCH_ASSOC)){
