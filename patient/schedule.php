...
$userfetch = $stmt->fetch(PDO::FETCH_ASSOC); // PDO: Mengambil hasil langsung dari $stmt
...
<body>
    <div class="container">
        ...
        $result = $database->query($sqlmain); // PDO query() mengembalikan PDOStatement
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr>
                    ...
                    <td>
                        <form action="" method="post" class="header-search">
                            ...
                            while ($row00 = $list11->fetch(PDO::FETCH_ASSOC)) { // PDO fetch() di dalam while loop
                                $d = $row00["docname"];
                            ...
                            // Loop 2: Fetching session titles
                            while ($row00 = $list12->fetch(PDO::FETCH_ASSOC)) { // PDO fetch() di dalam while loop
                                $d = $row00["title"];
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)"><?php echo $searchtype . " Sessions" . "(" . $result->rowCount() . ")"; ?> </p>
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <br><br><br><br>
                                            ...
                                            // Gunakan array untuk menyimpan semua hasil sebelum looping tampilan
                                            ...
                                            while ($rows_processed < $row_count) {
                                                echo "<tr>";
                                                for ($q = 0; $q < $rows_per_tr; $q++) {
                                                    if ($rows_processed < $row_count) {
                                                        $row = $all_rows[$rows_processed];
                                    ...
                                    <div class="dashboard-items search-items" >
                                        ...
                                        <div style="width:100%">
                                            ...
                                            <a href="booking.php?id=' . $scheduleid . '" ><button class="login-btn btn-primary-soft btn " style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">Book Now</font></button></a>
                                                        ...
                                                        echo '<td style="width: 25%;"></td>'; // Isi sisa kolom dengan kosong jika tidak ada data lagi
                                                    }
                                                }
                                                echo "</tr>";
                                            }
