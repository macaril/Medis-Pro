...
<body>
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Settings</p>
                            ...
                            <td width="15%">
                                ...
                                // PERBAIKAN: Konversi query() ke PDO dan hitung dengan rowCount()
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            // PERBAIKAN: Konversi query view ke PDO Prepared Statement
            ...
            // PERBAIKAN: Konversi query edit ke PDO Prepared Statement
            $sqlmain= "select * from patient where pid=?";
            $stmt = $database->prepare($sqlmain);
            $stmt->execute([$id]);
            $row=$stmt->fetch(PDO::FETCH_ASSOC);
